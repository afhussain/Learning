...
namespace ASP.NET_Core_Routing
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Each middleware is invoked twice per request giving the effect of the counter incrementing by 2
            ...
            // Just another simple route
            app.MapGet("3", () => "Hello World for route '/3'");

            // Another bit of middleware using the same class for start of pipeline
            ...
            // Use static class to handle endpoint of the format x/y/... where the first two segments 
            // of the route are integers followed by any number of segments in any format
